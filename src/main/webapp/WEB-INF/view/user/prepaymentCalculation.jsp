...
<body>
	...
	<div class="container">
		<ol class="breadcrumb">
			...
			<li class="active">Pre-Payment Calculation</li>
		</ol>
				...
				<div class="col-md-6">
					<div id="clientTopDiv">
						<div class="cientTopLeft">
							<h4>
								<i class="fa fa-cc fa-lg"></i>&nbsp;&nbsp;Pre-Payment
								Calculation
							</h4>
						</div>
					</div>
