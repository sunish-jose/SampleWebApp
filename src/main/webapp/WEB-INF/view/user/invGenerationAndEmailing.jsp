...
<body>
	...
	<div class="container">
		<ol class="breadcrumb">
			...
			<li class="active">Invoice Generation and Emailing</li>
		</ol>
		<div class="blueBorderDiv">
				...
				<div class="col-md-12">
					<div id="clientTopDiv">
						<div class="cientTopLeft">
							<h4>
								<i class="fa fa-file-o fa-lg"></i>&nbsp;&nbsp;Invoice Generation
								and Emailing
							</h4>
						</div>
					</div>
			...
			<div class="row topPaddingLarge">
				...
				<div class="col-md-6 topPaddingSmall bodypadding">
					<button type="button" id="searchInvoice" class="btn btn-primary">
				...
				<div class="row topPaddingLarge">
						...
						<table class="table table-bordered  table-curved hoveringTable"
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="checkbox" id="c2" checked
								...
								<tr>
									...
									<td><input type="checkbox" id="c2" disabled="disabled"></td>
								</tr>
								<tr>
									<td>LBJKY</td>
									<td>LBABC</td>
					...
					<span class="pull-right">
						<button type="button" id="120Action"
							...
							Generate Invoice&nbsp;<i class="fa fa-cog"></i>&nbsp;
						</button>
						<button type="button" id="500Action"
							class="btn  btn-success">
							Email Invoice&nbsp;<i class="fa fa-envelope-o"></i>
						</button></span>
						</div>
					</div>
				</div>
