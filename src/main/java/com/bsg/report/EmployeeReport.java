...
public class EmployeeReport {
    ...
    private DynamicReport getReport(Style headerStyle, Style detailTextStyle, Style detailNumStyle) throws ColumnBuilderException, ClassNotFoundException {
        ...
        AbstractColumn columnEmpNo = createColumn("empNo", Integer.class,"Employee Number", 25, headerStyle, detailTextStyle);
        AbstractColumn columnFullName = createColumn("employFullName", String.class,"Full Name", 35, headerStyle, detailTextStyle);
        AbstractColumn columnFirstName = createColumn("employFirstName", String.class,"First Name", 30, headerStyle, detailTextStyle);
        AbstractColumn columnLastName = createColumn("employLastName", String.class,"Last Name", 30, headerStyle, detailTextStyle);
        AbstractColumn columnSalary = createColumn("salary", Integer.class,"Salary", 25, headerStyle, detailNumStyle);
        AbstractColumn columnCommission = createColumn("commission", Float.class,"Commission", 25, headerStyle, detailNumStyle);
        
        report.addColumn(columnEmpNo)
        .addColumn(columnFirstName)
        .addColumn(columnLastName)
        .addColumn(columnFullName)
        .addColumn(columnSalary).addColumn(columnCommission);
