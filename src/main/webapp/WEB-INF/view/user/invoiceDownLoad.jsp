...
<script>
	$(document).ready(function() {
		...
		$('#searchInvoiceRec').click(function() {
			$('#searchResultsDiv').show();
		});

		$('#searchInvoicePay').click(function() {
			$('#searchResultsDiv').show();
		});
		...
		<div class="blueBorderDiv">
				...
				<div class="col-md-12">
					<div id="clientTopDiv">
						<div class="cientTopLeft">
							<h4>
								<i class="fa fa-file-o fa-lg"></i>&nbsp;&nbsp;View Invoices
							</h4>
						</div>
					</div>
				</div>
			...
			<div class="row topPaddingLarge">
				...
				<div class="col-md-6 topPaddingLarge bodypadding">
					<button type="button" id="searchInvoiceRec"
						class="btn  btn-primary">
						Get Receivable Invoice&nbsp;<i class="fa fa-download"></i>
					</button>
					<button type="button" id="searchInvoicePay"
						class="btn  btn-primary">
						Get Payable Invoice&nbsp;<i class="fa fa-download"></i>
					</button>
				</div>
			</div>
		...
		<div id="searchResultsDiv">
			<div class="row topPaddingLarge">
				...
				<div class="col-md-12 bodypadding">
						<button type="button" id="500Action" class="btn  btn-success pull-right">
							Download All&nbsp;<i class="fa fa-download"></i>&nbsp;
						</button>
					</div>
			</div>
		</div>
						...
						<div class="FixedHeightContainer topPaddingLarge">
							<div class="Content">
								<div class="row">
									<div class="col-md-2">
										<div>
											<span><input type="checkbox" id="tp1" class="chkhide"><label
												for="tp1">01/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp2" class="chkhide"><label
												for="tp2">02/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp3" class="chkhide"><label
												for="tp3">03/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp4" class="chkhide"><label
												for="tp4">04/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp5" class="chkhide"><label
												for="tp5">05/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp6" class="chkhide"><label
												for="tp6">06/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp7" class="chkhide"><label
												for="tp7">07/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp8" class="chkhide"><label
												for="tp8">08/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp9" class="chkhide"><label
												for="tp9">09/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp10" class="chkhide"><label
												for="tp10">10/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp11" class="chkhide"><label
												for="tp11">11/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp12" class="chkhide"><label
												for="tp12">12/2014</label></span>
										</div>
										<div>
											<span><input type="checkbox" id="tp13" class="chkhide"><label
												for="tp13">01/2015</label></span>
										</div>
									</div>
								</div>
							</div>
